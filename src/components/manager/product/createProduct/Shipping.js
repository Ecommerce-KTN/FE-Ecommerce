...
function Shipping() {
  ...
  return(
    <>
      <div style={{border: "1px solid #d9d9d9", padding: "10px", width: "25rem"}}>
        ...
        <FormControl sx={{ m: 1, width: '40ch' }} variant="outlined">
          <InputLabel shrink htmlFor="" sx={{
            ...
            left: '-13px',
            fontSize: '18px'
          }}>Items Weight</InputLabel>
          <OutlinedInput
            id="outlined-adornment-weight"
            endAdornment={<InputAdornment position="end"><Dropdown options={optionsWeight}/></InputAdornment>}
            aria-describedby="outlined-weight-helper-text"
            inputProps={{ 
              'aria-label': 'weight',
            }}
