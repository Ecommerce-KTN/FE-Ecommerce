    ...
    <>
      <div>
        ...
        <div className='flex justify-between'>
          <button className='text-center text-white w-[29rem] bg-gray-900 border-2 rounded-lg py-2'>
            Add to cart
          </button>
      ...
      <div className='m-auto w-11/12 relative'>
        <div className='flex'>
          <div className='w-8/12 mr-5 '>
            <img
              src='https://cdn2.cellphones.com.vn/x/media/catalog/product/s/a/samsung_galaxy_s24_ultra_256gb_-_2.png'
              className='rounded-xl w-full'></img>
          </div>
          <div className='w-4/12 '>
            ...
            <div className='my-3'>
              ...
              <div className='flex gap-3'>
                <button className='min-w-[60px] min-h-[28px] rounded-lg ring-2 ring-slate-400 focus:ring focus:ring-gray-600'>
                  4GB
                </button>
                <button className='min-w-[60px] min-h-[28px] rounded-lg ring-2 ring-slate-400 focus:ring focus:ring-gray-600'>
                  8GB
